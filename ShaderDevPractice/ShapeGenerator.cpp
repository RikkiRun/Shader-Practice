...
ShapeDate ShapeGenerator::flipMakeCube()
{
...
ShapeDate ShapeGenerator::makeTeapot(uint tesselation, const glm::mat4& lidTransform)
{
	ShapeDate ret;
...
ShapeDate ShapeGenerator::generateNormals(const ShapeDate & data)
{
	ShapeDate ret;
